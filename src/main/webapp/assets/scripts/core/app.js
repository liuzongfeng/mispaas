...
var App = function () {
    ...
    var handlePortletTools = function () {
        ...
        jQuery('body').off('click','.portlet > .portlet-title > .tools > .collapse, .portlet .portlet-title > .tools > .expand').on('click', '.portlet > .portlet-title > .tools > .collapse, .portlet .portlet-title > .tools > .expand', function (e) {
            e.preventDefault();
            var el = jQuery(this).closest(".portlet").children(".portlet-body");
    ...
    return {
        ...
        scrollTo: function (el, offeset) {
            ...
            // jinchb mod:解决点击"文件夹"，列表滚动条会上移动一段问题.20170329
